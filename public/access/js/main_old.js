...
jQuery(window).on("load", function () {
    ...
    $(document).on('submit', 'form#modalForm, form#footerForm', function(e){
        e.preventDefault();
    ...
    $(document).mouseup( function(e){ // событие клика по веб-документу
        var div = $( ".content_modal" ); // тут указываем ID элемента
    ...
    $(document).on('click', '.tabs_op button ', function(){
        $('.tabs_op button').removeClass('active')
        $(this).addClass('active')
        var attrTab = $(this).attr('attr-open');


        $('.bitrok .item_port').hide();

        $( ".bitrok .item_port[attr-cat$=" + attrTab + "]" ).show();
